                        ...
                        >
                            ...
                            @forelse($logs as $index => $log)
                                ...
                                >
                                    ...
                                    <td class="whitespace-nowrap text-gray-900 dark:text-gray-200">{!! \Credizombies\LogViewer\Utils\Utils::highlightSearchResult($log->time->toDateTimeString(), $query) !!}</td>
                                    <td class="whitespace-nowrap text-gray-500 dark:text-gray-300 dark:opacity-90 hidden lg:table-cell">{!! \Credizombies\LogViewer\Utils\Utils::highlightSearchResult($log->environment, $query) !!}</td>
                                    <td class="max-w-[1px] w-full truncate text-gray-500 dark:text-gray-300 dark:opacity-90">{!! \Credizombies\LogViewer\Utils\Utils::highlightSearchResult($log->text, $query) !!}</td>
                                ...
                                <tr x-show="$store.logViewer.isOpen({{$index}})"><td colspan="6">
                                        <pre class="log-stack">{!! \Credizombies\LogViewer\Utils\Utils::highlightSearchResult($log->fullText, $query) !!}</pre>
                                        @if($log->fullTextIncomplete)
                                            <div class="py-4 px-8 text-gray-500 italic">
                                                The contents of this log have been cut short to the first {{ \Credizombies\LogViewer\Utils\Utils::bytesForHumans(\Credizombies\LogViewer\Facades\LogViewer::maxLogSize()) }}.
