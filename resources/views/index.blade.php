...
<head>
    ...
    <link rel="shortcut icon" href="https://members.creditzombies.com/images/favicon.png">
...
<body class="h-full px-5 bg-gray-100 dark:bg-gray-900"
      ...
      x-init="$nextTick(() => {
        ...
        @if(\Creditzombies\LogViewer\Facades\LogViewer::shouldEagerScanLogFiles()) $dispatch('scan-files'); @endif
